DOCKER_COMPOSE_DIR=.
DOCKER_COMPOSE_FILE=$(DOCKER_COMPOSE_DIR)/development-compose.yml
...
docker-stop-all: docker-init ## Stop all docker containers. To only stop one container, use CONTAINER=<service>
